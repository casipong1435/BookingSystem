...
class TourismController extends Controller
{
    ...
    public function home(){
        ...
        return view('staff-tourism.tourism-home');
    }
    ...
    public function reservation(){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.reservation');
    }
    ...
    public function history(){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.history');
    }
    ...
    public function facilities(){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.facilities');
    }
    ...
    public function images($item_id){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.more-images',['decrypted_id' => $decrypted_id]);
    }
    ...
    public function equipments(){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.equipments');
    }
    ...
    public function accounts(){
        ...
        Session::forget('item_type');
        Session::forget('history');
        return view('staff-tourism.account-list');
    }
    ...
    public function itempricing($item_id){ 
        ...
        return view('staff-tourism.itempricing',['encrypted_id' => $encrypted_id]);
    }
    ...
    public function ReservationDetails($id){ 
        ...
        return view('staff-tourism.reservation-details',['encrypted_id' => $encrypted_id]);
    }
    ...
    public function HistoryDetails($item_id){ 
        ...
        return view('staff-tourism.history-details',['booking_item_id' => $booking_item_id]);
    }
