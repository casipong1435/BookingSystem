...
class MoreImages extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.tourism.more-images', ['images' => $images]);
    }
    ...
    public function addImage(){
        ...
        try{
            foreach($this->photos as $photo){
                ...
                $photo->storeAs('tourism-more-images', $filename);
    ...
    public function deleteImage($image_name){
        ...
        $filepath = public_path('/images/tourism-more-images/'.$image_name);
