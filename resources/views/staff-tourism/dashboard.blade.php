    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="{{ route('tourismhome') }}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'tourismhome' ? 'current fw-bold' : ' '  }}">
                    <i class="bi bi-house me-2"></i>Home
                </a>
                <a href="{{route("tourismequipments")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'tourismequipments' || session()->get('item_type') == 'equipment' ? 'current fw-bold' : ' '  }}">
                    <i class="bi bi-truck me-2"></i>Equipments & Others
                </a>
                <a href="{{route("tourismfacilities")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'tourismfacilities' || session()->get('item_type') == 'facility' ? 'current fw-bold' : ' '  }}">
                    <i class="bi bi-person-workspace me-2"></i>Facilities
                </a>
                <a href="{{route("tourismreservation")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'tourismreservation' || session()->get('reservation') == true ? 'current fw-bold' : ' '  }}">
                    <i class="bi bi-bookmark me-2"></i>Reservation
                </a>
                <a href="{{route("accounts")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'accounts' ? 'current fw-bold' : ' '  }}">
                    <i class="bi bi-person me-2"></i>Accounts
                </a>
                <a href="{{route("tourismhistory")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'tourismhistory' || session()->get('history') == true ? 'current fw-bold' : ' '  }}">
