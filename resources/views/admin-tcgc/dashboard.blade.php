    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                    <a href="{{ route('admintcgchome') }}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgchome' ? 'current fw-bold' : ' '  }}">
                        <i class="bi bi-house me-2"></i>Home
                    </a>
                    <a href="{{route("admintcgcequipments")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgcequipments' ? 'current fw-bold' : ' '  }}">
                        <i class="bi bi-truck me-2"></i>Equipments & Others
                    </a>
                    <a href="{{route("admintcgcfacilities")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgcfacilities' ? 'current fw-bold' : ' '  }}">
                        <i class="bi bi-person-workspace me-2"></i>Facilities
                    </a>
                    <a href="{{route("admintcgcaccounts")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgcaccounts' ? 'current fw-bold' : ' '  }}">
                        <i class="bi bi-person me-2"></i>Accounts
                    </a>
                    <a href="{{route("admintcgcreservation")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgcreservation' || session()->get('reservation') == true ? 'current fw-bold' : ' '  }}">
                        <i class="bi bi-bookmark me-2"></i>Reservation
                    </a>
                    <a href="{{route("admintcgchistory")}}" wire:navigate class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'admintcgchistory' || session()->get('history') == true ? 'current fw-bold' : ' '  }}">
