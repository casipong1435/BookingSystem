<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-2">Tangub City Booking</h3>
        ...
        <div class="col-lg-4 p-4">
            ...
            <a href="{{route("index")}}" class="d-inline-block mb-2 text-dark text-decoration-none">Home</a><br>
...
<h6 class="text-center bg-dark text-white p-3 m-0">THESIS BY CS STUDENT OF TCGC</h6>
