<div>
    ...
    <div class="col-md-12 mb-2 p-2">
        <div class="row d-flex justify-content-around p-2">
            <div class="col-lg-2 m-1 d-flex shadow justify-content-center align-items-center py-4 rounded">
            ...
            <div class="col-lg-4 m-1 d-flex shadow justify-content-center align-items-center py-4 rounded user-content">
                <a href="{{auth()->user()->role == 'admin-tcgc' ? route("admintcgcaccounts"):route("tcgcaccounts")}}" class="text-decoration-none">
                    <div>
            ...
            <div class="col-md-12 p-3 mt-1">
                <div class="row p-2 d-flex justify-content-around">
                    <div class="col-lg-3 m-2 d-flex justify-content-center shadow py-4 rounded reservation-content">
                        <a href="{{ auth()->user()->role == 'admin-tcgc' ? route("admintcgcreservation"):route("tcgcreservation") }}" class="text-decoration-none">
                            <div>
