<div>
    ...
    @switch($state)
        @case(0)
                @include('livewire.tcgc.account-category.pending')
            @break
        @case(1)
                @include('livewire.tcgc.account-category.approved')
            @break
        @case(2)
                @include('livewire.tcgc.account-category.banned')
            @break
        @case(3)
                @include('livewire.tcgc.account-category.officials')
            @break
