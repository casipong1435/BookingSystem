                ...
                @foreach ($banned_users as $user)
                    <tr>
                        ...
                        <td data-label="Action">
                            <button type="button" class="btn btn-secondary mx-1" wire:click.prevent="updateUserType('{{ $user->username }}',{{ 2 }}, 'unban')" wire:confirm="Are you sure you want to unban this user?">
                                <div wire:loading wire:target="updateUserType('{{ $user->username }}',{{ 2 }}, 'unban')" wire:key="updateUserType">
