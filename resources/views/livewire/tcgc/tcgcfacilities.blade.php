<div class="row">
  ...
  @include('partials.additem')
    ...
    <div class="col-md-12 p-2">
        ...
        @if (count($facility_tcgc) > 0)
            <div class="row px-3 mb-3">
                <div class="col-md-12 px-3">
                    <h5  class="text-center my-3">TCGC Facilities</h5>

                    @foreach ($facility_tcgc as $tcgc)
                    <?php
                      $item_id = [
                    ...
                    ?>
                        <div class="card mb-4 shadow border-0 {{ ($tcgc->status == 2) ? 'archived-bg':'' }}">
                            ...
                            <div class="col-lg-2 mt-lg-0 mt-md-0 mt-4 text-center">
                                <button type="button" class="btn btn-sm w-100 btn-outline-primary shadow-none mb-2" wire:key="editFacilityItem" wire:click="getItemID({{ $tcgc->item_id }})" data-bs-toggle="modal" data-bs-target="#TourismEditItem">Edit</button>
                                @if ($tcgc->status != 2)
