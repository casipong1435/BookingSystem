        ...
        @if (count($facility_data) > 0)
            <div class="row px-3 mb-3">
                <div class="col-md-12  px-3">
                    @foreach ($facility_data as $tourism)
                    <?php
                        $item_id = [
                            ...
                            <div class="row g-0 p-3 align-items-center">
                                ...
                                <div class="col-md-5 px-lg-3 px-md-3 px-0">
                                    ...
                                    <div class="features mb-4">
                                        ...
                                        <span class="badge rounded-pill bg-light text-dark text-wrap fw-bold" style="text-align: justify">
                                            {{ $tourism->description }}
                                        </span>
                              ...
                              <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                                ...
                                <button type="button" class="btn btn-sm w-100 btn-outline-primary shadow-none mb-2" wire:key="editFacilityItem" wire:click="getItemID({{ $tourism->item_id }})" data-bs-toggle="modal" data-bs-target="#TourismEditItem">Edit</button>
                                  @if ($tourism->status != 2)
                                  ...
                                  @endif
                                <button type="button" class="btn btn-sm w-100 btn-outline-danger shadow-none" wire:click="deleteItem('{{ $tourism->item_id }}', '{{ $tourism->item_img }}')" wire:confirm="Are you sure you want to delete this facility?">Delete</button>
                              </div>
                            </div>
                        </div>
                    @endforeach
