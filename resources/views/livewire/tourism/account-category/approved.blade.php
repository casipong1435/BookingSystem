                ...
                @foreach ($approved_users as $user)
                    <tr>
                        ...
                        <td data-label="Action">
                            ...
                            @endif
                            <button type="button" class="btn btn-danger mx-1" wire:click.prevent="updateUserStatus('{{ $user->username }}',{{ 2 }}, 'ban')" wire:confirm="Are you sure you want to ban this user?">
                                <div wire:loading wire:target="updateUserStatus('{{ $user->username }}',{{ 2 }}, 'ban')" wire:key="updateUserStatus">
