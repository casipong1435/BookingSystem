<section class="container" id="finished-reservation">
    <h3 class="fw-bold text-center" ><u>Completed Reservations</u></h3>
    ...
    <div class="row p-3">
        @if (count($user_finished_equipment) > 0 || count($user_finished_facility) > 0 )
            @foreach ($user_finished_equipment as $reservation)
            ...
            @foreach ($user_finished_facility as $reservation)
            <div class="col-md-5 m-1">
                <div class="shadow">
                    <div class="p-2" style="background: #dd8c22">
                        <div class="item_name text-center fw-bold ">{{ $reservation->item_name }}</div>
            ...
            @endforeach
        @else
            <h3 class="text-center">No Completed Reservation.</h3>
        @endif
    </div>
</section>