@if ($state == 3)
    <div class="row text-center d-flex justify-content-center" id="rejected-reservation">
        @if (count($rejected_booked_equipment) > 0 || count($rejected_booked_facility) > 0 || count($rejected_booked_tcgc) > 0)

            @if (count($rejected_booked_equipment) > 0 || count($rejected_booked_facility) > 0)
                <h1 class="text-center">CITY</h1>
                @foreach ($rejected_booked_equipment as $item_equipment)
                <div class="col-lg-4 m-3">
                    <div class="shadow">
                        ...
                        <div class="form-group border d-flex justify-content-between p-2">
                            <div>Status:</div>
                            <div class="text-white bg-danger">Rejected</div>
                        </div>
                        <div class="form-group border d-flex justify-content-between p-2">
                            <div>Quantity:</div>
            ...
            @foreach ($rejected_booked_facility as $item_facility)
                <div class="col-lg-4 m-3">
                    <div class="shadow">
                        <div class="form-group border p-2 position-relative">
            ...
            @if (count($rejected_booked_tcgc) > 0)
                <br>
                <br>
                <h1 class="text-center">TCGC</h1>
                @foreach ($rejected_booked_tcgc as $item_tcgc)
                <div class="col-lg-4 m-3">
                    <div class="shadow">
                        <div class="form-group border p-2 position-relative">
